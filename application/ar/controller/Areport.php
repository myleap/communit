...
class Areport extends \think\Controller {
...
//        $this->assign('comments', json_encode($this->getComments()));
//        return $this->fetch();
    }
...
//        $url = request()->root(true) . '/' . request()->path();
        $url = 'https://www.myleap.cn/community/public/index.php/ar/areport/login';
        ...
        if (isset($_SESSION['token']['access_token'])) {
            ...
            dump($userinfo);
            header('Location:' . Url('areport/index')); //跳转到第三方登录入口    
            exit;
        }
    }
