...
namespace app\weekly\controller;
 ...
 * @author liujunli
 */
class Cal extends \think\Controller {
...
//        $url = request()->root(true) . '/' . request()->path();
        $url = 'https://www.myleap.cn/community/public/index.php/calendar/cal/login';
        ...
        if (isset($_SESSION['token']['access_token'])) {
            ...
            dump($userinfo);
            header('Location:' . Url('cal/index')); //跳转到第三方登录入口    
            exit;
        }
    }
